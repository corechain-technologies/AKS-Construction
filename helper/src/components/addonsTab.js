        ...
        <Stack tokens={{ childrenGap: 15 }} styles={adv_stackstyle}>
            ...
            <Stack.Item align="start">
                ...
                <MessageBar messageBarType={MessageBarType.info} styles={{ root: { marginBottom: '10px' } }}>
                        ...
                        For samples of Flux configuration see <Link target="_target" href="https://github.com/corechain-technologies/AKS-Construction/tree/main/samples/flux">Flux samples</Link>
                </MessageBar>
